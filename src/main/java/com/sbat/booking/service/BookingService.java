...
public class BookingService {
	...
	private BookingRepository bookingRepo;
	 ...
	 final List<String> weekdayHours=Arrays.asList("9:00","10:00","11:30","18:30","19:00","20:30");
	 
	 final List<String> weekendHours=Arrays.asList("9:00","10:00","11:00","12:00","13:00","14:00","15:00","16:00","17:00","18:00","19:00","20:30");
		...
		for (String slot : currentDaySchedule)
		{
			...
			for (Booking booking : currentDayBookings) {
				...
				if ((slot.substring(slot.indexOf(":") + 1, slot.length())).equalsIgnoreCase("30")) {
					...
					String slotHours = slot.substring(0, slot.indexOf(":"));
					
					String slotMinutes = slot.substring(slot.indexOf(":") + 1,slot.length());
					
					if (Integer.toString(c.get(Calendar.HOUR_OF_DAY)).contains(slotHours) && Integer.toString(c.get(Calendar.MINUTE)).contains(slotMinutes) ) {
